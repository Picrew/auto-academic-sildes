...
# Evidence Art Director Bridge

This is a generated bridge for `evidence-art-director`.
The canonical workflow lives in `.codex/skills/evidence-art-director/SKILL.md`.

## Instructions

1. Read `.codex/skills/evidence-art-director/SKILL.md` before doing substantive work.
