...
# High Sense Renderer Critic Bridge

This is a generated bridge for `high-sense-renderer-critic`.
The canonical workflow lives in `.codex/skills/high-sense-renderer-critic/SKILL.md`.

## Instructions

1. Read `.codex/skills/high-sense-renderer-critic/SKILL.md` before doing substantive work.
